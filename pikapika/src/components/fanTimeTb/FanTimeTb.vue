<template>
  <div class="block-wrap">
    <div class="fanTimeTb-box">
      ...
      <el-tabs v-model="activeName" :stretch="true" class="timetable">
        <el-tab-pane label="星期一" name="1">星期一</el-tab-pane>
        <el-tab-pane label="星期二" name="2">星期二</el-tab-pane>
        <el-tab-pane label="星期三" name="3">星期三</el-tab-pane>
        <el-tab-pane label="星期四" name="4">星期四</el-tab-pane>
        <el-tab-pane label="星期五" name="5">星期五</el-tab-pane>
        <el-tab-pane label="星期六" name="6">星期六</el-tab-pane>
        <el-tab-pane label="星期日" name="7">星期七</el-tab-pane>
      </el-tabs>
